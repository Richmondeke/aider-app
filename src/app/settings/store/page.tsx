    ...
    return (
        <div className="space-y-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-black text-white tracking-tight italic">Store Front</h1>
                ...
                <div className="flex items-center gap-3">
                    <button className="bg-emerald-600 text-white px-6 py-3 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-emerald-500 transition-all shadow-xl shadow-emerald-600/20 flex items-center gap-2">
                        View Live Store
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="bg-zinc-900/40 border border-zinc-800 p-8 rounded-[40px] space-y-6">
                        <div className="flex items-center gap-4">
                            <div className="bg-blue-600/10 p-3 rounded-2xl text-blue-500 italic">
                                <Globe size={24} />
                            </div>
                            <h2 className="text-xl font-black text-white italic">Public Identity</h2>
                        </div>

                        <div className="space-y-4">
                            <div className="space-y-2">
                                <label className="text-[10px] font-black text-zinc-500 uppercase tracking-widest ml-4 italic">Store Subdomain</label>
                                <div className="flex items-center gap-2 bg-zinc-950 border border-zinc-800 p-2 rounded-2xl focus-within:border-blue-500 transition-all">
                                    <input
                                        type="text"
                                        defaultValue="my-cool-business"
                                        className="bg-transparent border-none outline-none flex-1 py-2 px-4 text-white font-bold"
                                    />
                                    <span className="text-zinc-600 font-bold pr-4">.aider.shop</span>
                                </div>
                            </div>

                            <div className="flex items-center gap-2 text-blue-500 text-xs font-black uppercase tracking-widest px-4 hover:underline cursor-pointer italic">
                                <Lock size={12} />
                    ...
                    <div className="bg-zinc-900/40 border border-zinc-800 p-8 rounded-[40px] space-y-6">
                        <div className="flex items-center gap-4">
                            ...
                            <h2 className="text-xl font-black text-white italic">Visual Experience</h2>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {[
                                ...
                                <div key={idx} className="bg-zinc-950 border border-zinc-800 p-5 rounded-2xl space-y-2">
                ...
                <div className="space-y-8">
                    <div className="bg-zinc-900/40 border border-zinc-800 p-8 rounded-[40px] space-y-6">
                        <div className="flex items-center justify-between">
                            ...
                            <Settings className="text-zinc-500 hover:text-white transition-colors cursor-pointer" size={18} />
                        </div>

                        <div className="relative aspect-[9/16] bg-zinc-950 rounded-[32px] border-[8px] border-zinc-800 overflow-hidden shadow-2xl">
                    ...
                    <div className="bg-blue-600/5 border border-blue-600/10 p-6 rounded-3xl space-y-3">
                        <div className="flex items-center gap-2 text-blue-500 text-xs font-black uppercase tracking-widest italic">
