    ...
    return (
        <div className="max-w-[1500px] mx-auto space-y-8">
            ...
            <div className="flex flex-col lg:flex-row gap-8 items-start">
                {/* Settings Sidebar */}
                <div className="w-full lg:w-[320px] bg-zinc-900/40 border border-zinc-800 rounded-[40px] p-4 shrink-0">
                    <nav className="space-y-2">
                        {settingsNav.map((item) => {
                            ...
                            return (
                                ...
                                >
                                    <item.icon size={20} className={cn(isActive ? "text-white" : "text-zinc-600 group-hover:text-zinc-400")} />
