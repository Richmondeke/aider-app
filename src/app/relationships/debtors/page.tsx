        ...
        <div className="space-y-8 max-w-[1400px] mx-auto">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold text-white tracking-tight">Debtor List</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-zinc-900/40 border border-zinc-800 p-8 rounded-[40px] relative overflow-hidden group">
                    ...
                    <p className="text-4xl font-black text-white mt-1">₦351,900.00</p>
                    <div className="mt-4 flex items-center gap-2 text-red-500 text-xs font-bold">
                        <TrendingUp size={16} />
                        +12.5% from last month
                    </div>
                </div>
                <div className="bg-zinc-900/40 border border-zinc-800 p-8 rounded-[40px]">
                ...
                <div className="p-8 border-b border-zinc-800 bg-zinc-950/20 flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div className="flex-1 relative">
                        ...
                        <input
                            ...
                            className="w-full bg-zinc-950 border border-zinc-800 rounded-2xl py-3.5 pl-12 pr-4 text-sm text-white focus:border-red-500/50 outline-none transition-all"
                        />
                    </div>
                        ...
                        >
                            <div className="flex items-center gap-6 min-w-0 flex-1">
                                <div className={cn(
                                    ...
                                    debt.status === "Critical" ? "bg-red-500/10 border-red-500/20 text-red-500" : "bg-zinc-800 border-zinc-700/50 text-zinc-500"
                                )}>
                                    <User size={32} />
                                </div>
                                <div className="min-w-0 space-y-1">
                                    ...
                                    <h3 className="text-xl font-black text-white truncate">{debt.name}</h3>
                            ...
                            <div className="flex items-center gap-12 text-right">
                                ...
                                <div className="flex flex-col gap-0.5">
                                    ...
                                    <span className={cn(
                                        "text-2xl font-black",
                                        debt.status === "Critical" ? "text-red-500" : "text-white"
                                    )}>
                                        {debt.amount}
                                    </span>
                                </div>
                                <div className="flex items-center gap-3">
                                    <button className="bg-blue-600 hover:bg-blue-500 text-white px-6 py-3 rounded-2xl font-black text-xs uppercase tracking-widest transition-all">
                                        Collect
                                    </button>
