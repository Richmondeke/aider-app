    ...
    return (
        <div className="space-y-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-black text-white tracking-tight">Expiring Products</h1>
                    <p className="text-zinc-500 font-medium">Monitor and manage items reaching their shelf life.</p>
                </div>
                <div className="flex items-center gap-3">
                    <button className="bg-zinc-900 text-zinc-300 px-5 py-3 rounded-2xl font-bold text-sm border border-zinc-800 flex items-center gap-2 hover:bg-zinc-800 transition-all">
                        <Download size={18} />
                        Export Log
                    </button>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-red-500/10 border border-red-500/20 p-8 rounded-[32px] space-y-4">
                    ...
                    <div>
                        <p className="text-4xl font-black text-white tracking-tighter">14 Items</p>
                ...
                <div className="bg-amber-500/10 border border-amber-500/20 p-8 rounded-[32px] space-y-4">
                    ...
                    <div>
                        <p className="text-4xl font-black text-white tracking-tighter">42 Items</p>
                ...
                <div className="bg-blue-500/10 border border-blue-500/20 p-8 rounded-[32px] space-y-4">
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-widest text-blue-500 bg-blue-500/10 px-3 py-1 rounded-full italic">Total Value</span>
                    </div>
                    <div>
            ...
            <div className="bg-zinc-900/40 border border-zinc-800 rounded-[40px] overflow-hidden">
                <div className="p-8 border-b border-zinc-800 flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="relative flex-1 max-w-md">
                        ...
                        <input
                            ...
                            className="w-full bg-zinc-950 border border-zinc-800 rounded-2xl py-3 pl-12 pr-4 text-sm font-bold text-zinc-300 focus:border-blue-500 outline-none transition-all placeholder:text-zinc-600"
                        />
                    </div>
                    <div className="flex items-center gap-4">
                        <button className="flex items-center gap-2 text-zinc-400 hover:text-zinc-200 font-bold text-sm bg-zinc-950 px-4 py-3 rounded-xl border border-zinc-800">
                            <Filter size={18} />
                            All Severity
                        </button>
                    </div>
                                ...
                                <tr key={item.id} className="hover:bg-zinc-800/20 transition-colors group">
                                    <td className="py-6 px-8">
                                        <div className="flex flex-col">
                                            <span className="font-bold text-white text-sm group-hover:text-blue-400 transition-colors">{item.name}</span>
                                    ...
                                    <td className="py-6 px-8">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className={cn(
                                                "font-black text-sm",
                                                item.status === "Critical" ? "text-red-500" : "text-zinc-300"
                                            )}>{item.expiryDate}</span>
                                        </div>
                                    </td>
                                    <td className="py-6 px-8">
                                        <span className="font-bold text-zinc-300">{item.stock} units</span>
                                    </td>
                                    <td className="py-6 px-8">
                                        <span className={cn(
                                    ...
                                    <td className="py-6 px-8 text-right">
                                        <div className="flex items-center justify-end gap-2">
                                            <button className="bg-blue-600/10 hover:bg-blue-600 text-blue-500 hover:text-white px-4 py-2 rounded-xl text-xs font-black transition-all">
                                                DISCOUNT
                                            </button>
                                            <button className="p-2 hover:bg-zinc-800 rounded-xl transition-all text-zinc-600">
                ...
                <div className="p-8 bg-zinc-950/30 border-t border-zinc-800 flex items-center justify-center">
                    <button className="text-zinc-500 hover:text-white font-black text-xs uppercase tracking-widest transition-all">
                        Load More Records
                    </button>
                </div>
            </div>
