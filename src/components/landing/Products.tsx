            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <motion.div
                        ...
                        className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100 flex flex-col items-start"
                    >
                        <div className="p-4 bg-blue-50 rounded-2xl mb-8">
                        ...
                        <Link
                            href="/dashboard"
                            className="group inline-flex items-center gap-2 bg-black text-white px-6 py-3 rounded-full hover:bg-gray-800 transition-colors font-medium"
                        >
                            Access Tool
                    ...
                    <motion.div
                        ...
                        className="bg-gray-100/50 rounded-3xl p-8 md:p-12 border border-gray-100 border-dashed flex flex-col items-center justify-center text-center inset-0"
                    >
